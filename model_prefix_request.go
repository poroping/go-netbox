...
func (o *PrefixRequest) HasPrefix() bool {
	if o != nil && !IsNil(o.Prefix) {
		return true
	}
...
func (o *PrefixRequest) GetPrefixLength() int {
...
// and a boolean to check if the value has been set.
func (o *PrefixRequest) GetPrefixLengthOk() (*int, bool) {
	if o == nil || IsNil(o.PrefixLength) {
		return nil, false
	}
...
func (o *PrefixRequest) HasPrefixLength() bool {
	if o != nil && !IsNil(o.PrefixLength) {
		return true
	}
...
func (o *PrefixRequest) SetPrefixLength(v int) {
	o.PrefixLength = &v
}
